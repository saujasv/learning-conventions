...
from training.qwen_finetune.training.trainer import QwenTrainer
from training.qwen_finetune.training.params import TrainingArguments, ModelArguments
from training.qwen_finetune.training.train_utils import (
...
from training.qwen_finetune.training.monkey_patch_forward import (
...
def train(
    ...
    if model_args.model_type == "qwen2.5":
